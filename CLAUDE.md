...
bun scripts/gen-og.mjs   # regenerate og.png + OG share cards (real browser screenshots of each route; requires `bun run build` first) + PNG favicons from SVG sources
```
