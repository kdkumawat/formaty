...
export async function generateMetadata({
  ...
  // Per-route share card (public/og/<route>.png), generated by scripts/gen-og.mjs.
  const ogImage = `${SITE_URL}/og/${tool}.png`;
  return {
    title: pageTitle,
    ...
    openGraph: {
      ...
      siteName: "Formaty",
      type: "website",
      images: [{ url: ogImage, width: 1200, height: 630, alt: config.h1 }],
    },
    twitter: {
